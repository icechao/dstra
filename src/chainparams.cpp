...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04fcee4717d663656c8c3859135ea1b7d3296e0b597f4628e5546d90b3aff799e5a166ba84235146bc20a712ba3bb2a1830354878054d52c360deb0b6246bcdaeb");
        nDefaultPort = 5169;
        nRPCPort = 5170;
...
//        assert(false);
        ...
        assert(hashGenesisBlock == uint256("0x0000070d58e60579407f5682045004f1b6d799ef48321b2e4aa58f90cb822abe"));
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("049fbc1a32026967656e73f36a2636339effcd742cb3a180135c598711a689be513b4cb04a4fbe5fbeb7da255ebcd971c385b8f50967273156354b4dcf0ef0b348");
        nDefaultPort = 6169;
        nRPCPort = 6170;
        strDataDir = "testnet";
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 72175;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00004806d0cc080e062d72212ef759e511118a6cf0735b09eda698f69f954aa3"));

        vFixedSeeds.clear();
        vSeeds.clear();

        vSeeds.push_back(CDNSSeedData("dstra.io", "testnet-seeds.dstra.io"));
...
public:
    CRegTestParams() {
        ...
        nRPCPort = 7170;
        strDataDir = "regtest";
        assert(hashGenesisBlock == uint256("0x0b724b7f54e85191606b1f76718d80ded83778a6de083e45378f00e44120defb"));
